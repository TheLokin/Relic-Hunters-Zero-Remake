...
#region Botones.
	...
	minus_button = instance_create_layer(x+sprite_get_width(sprite_index)-56, y, "button_layer2", class_arrow_button);		// Botón izquierdo con el que interacciona.
...
#region Texto.
	...
	label_text_x = x+sprite_get_width(sprite_index)-72;				// Posición en el eje horizontal del texto.
	label_text_y = y+sprite_get_height(sprite_index)/2;				// Posición en el eje vertical del texto.
	label_text_second_x = x+sprite_get_width(sprite_index)-32;		// Posición en el eje horizontal del texto secundario.
