/// @function get_below_button()
/// @description Devuelve el botón inferior a uno dado en una room o el pasado si no tiene.
/// @param grid
/// @param button
/// @return button
...
#region Recorrido vertical.
	...
	for (var _i = _button.grid_y+1; _i < _height; _i++) {
...
#region Recorrido oblícuo.
	...
	for (var _y = _button.grid_y+1; _y < _height; _y++) {
