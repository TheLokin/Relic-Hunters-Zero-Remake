...
#region Arrows.
	...
	arrow_left = instance_create_layer(x+sprite_get_width(sprite_index)-56, y, "buttons", button_arrow);		// Left arrow.
...
#region Text.
	...
	text_x = x+sprite_get_width(sprite_index)-72;				// Position on the horizontal axis of the text.
	text_y = y+sprite_get_height(sprite_index)/2;				// Position on the vertical axis of the text.
	text_secondary_x = x+sprite_get_width(sprite_index)-32;		// Position on the horizontal axis of the secondary text.
